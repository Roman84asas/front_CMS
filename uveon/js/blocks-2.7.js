...
function t396_addVideo(ab, el) {
    ...
    if (typeof viyid != 'undefined' && viyid != '') {
        if (vihascover == 'y') {
            viel.html('<iframe id="youtubeiframe" width="100%" height="100%" data-original="//www.youtube.com/embed/' + viyid + '?rel=0&fmt=18&html5=1&showinfo=0&autoplay=1" frameborder="0" allowfullscreen data-flag-inst="y"></iframe>')
        } else {
            if (window.lazy == 'y') {
                viel.html('<iframe id="youtubeiframe" class="t-iframe" width="100%" height="100%" data-original="//www.youtube.com/embed/' + viyid + '?rel=0&fmt=18&html5=1&showinfo=0" frameborder="0" allowfullscreen data-flag-inst="lazy"></iframe>');
                el.append('<script>lazyload_iframe = new LazyLoad({elements_selector: ".t-iframe"});</script>')
            } else {
                viel.html('<iframe id="youtubeiframe" width="100%" height="100%" src="//www.youtube.com/embed/' + viyid + '?rel=0&fmt=18&html5=1&showinfo=0" frameborder="0" allowfullscreen data-flag-inst="y"></iframe>')
            }
        }
    }
    ...
    if (typeof vivid != 'undefined' && vivid > 0) {
        if (vihascover == 'y') {
            viel.html('<iframe class="t-iframe" data-original="//player.vimeo.com/video/' + vivid + '?title=0&byline=0&portrait=0&badge=0&color=ffffff&autoplay=1" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>')
        } else {
            if (window.lazy == 'y') {
                viel.html('<iframe class="t-iframe" data-original="//player.vimeo.com/video/' + vivid + '?title=0&byline=0&portrait=0&badge=0&color=ffffff" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
                el.append('<script>lazyload_iframe = new LazyLoad({elements_selector: ".t-iframe"});</script>')
            } else {
                viel.html('<iframe src="//player.vimeo.com/video/' + vivid + '?title=0&byline=0&portrait=0&badge=0&color=ffffff" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>')
            }
        }
    }
}
...
function t396_addTooltip(ab, el) {
    ...
    el.attr('data-fields', fields_str);
    t396_elem__renderView(el);
    el.find('.tn-atom__pin').mouseover(function () {
        t396_elem__renderViewOneField(el, 'tipposition')
    });
    setTimeout(function () {
    ...
    el.find('.tn-atom__tip-img').on("load", function () {
        t396_elem__renderViewOneField(el, 'tipposition')
    }).each(function () {
        if (this.complete) $(this).load()
    })
...
function t396_elem__renderViewOneField(el, field) {
    ...
    if (field == 'tipposition') {
        if (typeof value == 'undefined' || value == '') value = 'top';
        ...
        var padd = 15;
        if (value == 'top') el.find('.tn-atom__tip').css('top', '-' + (tiph * 1 + padd) + 'px').css('left', '-' + (tipw / 2 - pinw / 2) + 'px');
        if (value == 'right') el.find('.tn-atom__tip').css('top', (pinw / 2 - tiph / 2) + 'px').css('left', (pinw + padd) + 'px');
        if (value == 'bottom') el.find('.tn-atom__tip').css('top', (pinw * 1 + padd) + 'px').css('left', '-' + (tipw / 2 - pinw / 2) + 'px');
        if (value == 'left') el.find('.tn-atom__tip').css('top', (pinw / 2 - tiph / 2) + 'px').css('left', '-' + (tipw + padd) + 'px')
    }
}
